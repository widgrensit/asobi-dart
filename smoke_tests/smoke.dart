...
Future<void> main() async {
  ...
  // Attach match listeners BEFORE queuing to avoid a race with the server
  // pairing us immediately. The matchmaker pushes match.matched, which the
  // SDK surfaces on the typed onMatchmakerMatched stream.
  final matchedA =
      a.client.realtime.onMatchmakerMatched.stream.first.timeout(_matchJoinTimeout);
  final matchedB =
      b.client.realtime.onMatchmakerMatched.stream.first.timeout(_matchJoinTimeout);
